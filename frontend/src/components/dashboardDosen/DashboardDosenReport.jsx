    ...
    <>
      <div className="card w-full">
        ...
        <div className="flex justify-between">
          <div className="text-left rounded-2xl bg-orange-100 border-3 border-orange-300 text-orange-500 p-3 w-1/2">
            <div className="flex">
          ...
          <div className="text-left rounded-2xl bg-blue-100 border-3 border-blue-300 text-blue-500 p-3 w-1/2">
            <div className="flex justify-between items-center">
              <div className="flex items-center">
                ...
                <div className="mx-2">
                  ...
                  <p className="font-bold text-xs text-slate-400">Course Dibuat</p>
                </div>
              </div>
            </div>
            <hr className="my-2 mx-0 border-slate-400" />
