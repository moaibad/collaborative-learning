          ...
          <div className='rounded-lg bg-white shadow-md w-56 pb-2 relative'>
            ...
            <div>
              <div className='text-center space-y-0.5'>
                ...
                <p className='font-semibold text-xs text-slate-500 truncate'>{alldosen.universitas}</p>
                <p className='font-semibold text-xs text-slate-500 truncate'>{alldosen.jurusan}</p>
              </div>
