...
const CardSemuaKomunitas = ({ allkomunitas }) => {
  const topikList = allkomunitas.Topik.split(',');
  return (
          ...
          <div className='bg-gray-50 border-1 border-gray-200 rounded-xl shadow-sm text-left p-2 w-full h-full relative flex flex-col justify-between'>
            <div className="flex flex-col items-center h-full">
              <img
                ...
                src={allkomunitas.Image}
                alt=""
              />
              <p className='font-bold text-m text-center'>{allkomunitas.Nama}</p>
              <p className='text-xs text-center text-gray-500'>{allkomunitas.Kota}, {allkomunitas.Provinsi}</p>
              ...
              <div className="bg-blue-500 text-white px-2 py-1 rounded mt-2 w-2/3 mx-auto">
                <p className='text-xs text-center'>{allkomunitas.Jurusan}</p>
              </div>
            ...
            <div className='flex py-1 font-semibold text-gray-500'>
                <p className='text-xs mr-8 ml-4'>{allkomunitas.Bergabung}</p>
                <p className='text-xs'>{allkomunitas.Anggota}</p>
            </div>
          </div>
        </li>
      </ul>
