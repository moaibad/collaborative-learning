          ...
          <div className='rounded-lg bg-white shadow-md w-48 pb-2 relative'>
            ...
            <div>
              <div className='text-center space-y-0.5'>
                ...
                <p className='font-semibold text-xs text-slate-500 truncate'>{praktisi.asal_perusahaan}</p>
                <p className='font-semibold text-xs text-slate-500 truncate'>{praktisi.posisi}</p>
              </div>
